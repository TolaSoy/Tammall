      ...
      <div class="kv-card-header">
        <div class="row justify-content-between">
          ...
          <div class="col-12 col-sm-6 text-right align-self-end">
            <nuxt-link to="/categories/add" class="btn btn-primary">
                ...
                <div class="dropleft">
                  ...
                  >
                    <div class="drop-wrap">
                      <nuxt-link
                        class="dropdown-item"
                        :to="'/categories/add?id=' + category.id"
                      >
...
<script>
import retrieveCategories from "~/mixins/retrieveCategories";

export default {
  mixins: [retrieveCategories],
  methods: {
    getImage (url,size){
      if(url=="" || url==null){
        return null;
